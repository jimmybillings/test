...
export class CollectionSortDdComponent {
  ...
  constructor() {
    this.sortOptions = [
      { 'id': 0, 'label': 'DATE_MOD_NEWEST', 'value': 'modNewest', 'active': true, 'sort': { 's': 'lastUpdated', 'd': true }},
      { 'id': 1, 'label': 'DATE_MOD_OLDEST', 'value': 'modOldest', 'active': false, 'sort': { 's': 'lastUpdated', 'd': false }},
      { 'id': 2, 'label': 'DATE_CREATE_NEWEST', 'value': 'createNewest', 'active': false, 'sort': { 's': 'createdOn', 'd': true }},
      { 'id': 3, 'label': 'DATE_CREATE_OLDEST', 'value': 'createOldest', 'active': false, 'sort': { 's': 'createdOn', 'd': false }},
